...
var ZtreeCreator = function(treeId,url,initJson,dialogService){
	...
	this.showMenu = function(target,initLeft,initTop){
		if(!target || target.currentTarget) {
			target = jQuery(this);
		}

		var btnOffset =  target.offset();
		jQuery("#"+_menuContent).css({left:initLeft?initLeft:btnOffset.left + "px", top:initTop?initTop:( btnOffset.top + target.outerHeight()) + "px"}).slideDown("fast");
