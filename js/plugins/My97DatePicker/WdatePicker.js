...
$(function(){
	...
	$(document).delegate(".dateformat",'focus',function(){
		...
		WdatePicker({el:$(this)[0],doubleCalendar: false,dateFmt:format,alwaysUseStartDate:true,onpicked:onpickedAndCleared,oncleared:onpickedAndCleared});
		$(this).blur();
	});
	$(document).delegate(".date",'focus',function(){
		WdatePicker({el:$(this)[0],dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true});
		$(this).blur();
	});
//	$('.datetime').live('focus',function(){
	$(document).delegate(".datetime",'focus',function(){
		WdatePicker({el:$(this)[0],dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true});
		$(this).blur();
	});
...
//	$('.wdateTime').live('focus',function(){
	$(document).delegate(".wdateTime",'focus',function(){
		...
		WdatePicker({el:$(this)[0],dateFmt:dateFmt,alwaysUseStartDate:true});
		me.blur();
	});
